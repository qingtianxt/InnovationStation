...
<script type="text/javascript" src="/TempProject/js/jquery-1.12.1.js"></script>
<script type="text/javascript" src="/TempProject/js/jquery.validate.js"></script>
<link type="text/css" rel="stylesheet" href="/TempProject/css/sl.css">
<link type="text/css" rel="stylesheet" href="/TempProject/css/lhgcalendar.css">
<script type="text/javascript" src="/TempProject/js/lhgcore.js"></script>
<script type="text/javascript" src="/TempProject/js/lhgcalendar.js"></script>
<script type="text/javascript" src="/TempProject/layer/layer.js"></script>
</head>
<body bgcolor="#DDF2FC">
<div class="nav">
	您现在的位置：
...
<!-- 				<tr> -->
<!-- 					<td width="174">角色名称</td> -->
<!-- 					<td colspan="2" width="606"> -->
<%-- 						<input name="roleName" id="id" style="width:98%;height:30px" value="${role.roleName }"> --%>
<!-- 					</td> -->
<!-- 				</tr> -->
<!-- 			</table> -->
				...
				if(value==true){
					...
					layer.open({
						...
						btn1:function(index,layero){
							layer.close(index);
							window.location.href="${pageContext.request.contextPath}/back/role/roleServlet?method=list&result=list&msg=7";
						}
					})
				}else{
					//alert(1);
