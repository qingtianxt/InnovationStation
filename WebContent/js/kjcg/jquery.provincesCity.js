...
$.fn.ProvinceCity = function(){
	...
	//插入3个空的下拉框
	_self.append("<select id='select1' name=\"selectgm1\"></select>");
	_self.append("<select id='select2' name=\"selectgm2\"></select>");
	_self.append("<select id='select3' name=\"selectgm3\"></select>");
	//分别获取3个下拉框
