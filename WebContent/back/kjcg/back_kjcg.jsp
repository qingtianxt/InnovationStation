...
<!-- 上传信息 -->
<script type="text/javascript"
	src="${pageContext.request.contextPath }/js/kjcg/back_kjcg.js"></script>
	<script type="text/javascript"
...
<div class="nav">
			...
			<li class="nav-li"><a href="javascript:void(0)">科技成果</a></li>
				<li class="nav-li"><a href="javascript:void(0)">添加科技成果</a></li>
			</ul>
		</div>
	<form
		action="${pageContext.request.contextPath }/back/kjcg/cgzhxmServlet?method=addCgzhxm"
		method="post" id="checkForm">
		<div class="table" align="center">
			<h1>成果转化项目库</h1>
			<table width="800" height="570" border="1" style="border-collapse: collapse;" class="form-table">
				<tr>
					<td width="110"><div align="center">成果名称&nbsp;&nbsp;<font style="color: red">*</font> </div></td>
					<td colspan="3"><input id="cgmc" name="mc" type="text" /></td>
				</tr>
				<tr>
					<td><div align="center">批准登记号&nbsp;&nbsp;<font style="color: red">*</font> </div></td>
					...
					<td width="200">
						...
						id="gclb" name="cglb" style="width: 99%">
				...
				<tr>
					<td><div align="center">成果所属单位&nbsp;&nbsp;<font style="color: red">*</font> </div></td>
					<td colspan="3"><input id="cgssdw" name="dw" type="text" /></td>
				</tr>
				<tr>
					<td><div align="center">通讯地址&nbsp;&nbsp;<font style="color: red">*</font> </div></td>
					<td colspan="3"><input id="txdz" name="dz" type="text"
						size="54" /></td>
				</tr>
				<tr>
					<td><div align="center">成果体现形式&nbsp;&nbsp;<font style="color: red">*</font> </div></td>
					<td colspan="3">
				...
				<tr>
					<td><div align="center">登记日期&nbsp;&nbsp;<font style="color: red">*</font> </div></td>
					...
					<td><select id="ssgxjslb" name="jslb" style="width: 99%">
				...
				<tr>
					...
					<td>
						...
						id="cgsp" name="sp" style="width: 99%">
				...
				<tr>
					...
					<td>
						...
						id="cgscjd" name="jd" style="width: 99%">
					...
					<td>
						...
						id="yyzt" name="yyzt" style="width: 99%">
				...
				<tr>
					<td><div align="center">技术所属领域&nbsp;&nbsp;<font style="color: red">*</font> </div></td>
					<td colspan="3">
				...
				<tr>
					...
					<td>
						...
						id="cgsx" name="cgsx" style="width: 99%">
				...
				<tr>
					<td><div align="center">成果应用行业&nbsp;&nbsp;<font style="color: red">*</font> </div></td>
				...
				<tr>
					<td height="171" colspan="4"><textarea id="jj" name="gbnr"
							style="width: 781px; height: 241px"></textarea></td>
				</tr>
			</table>
			<br> <br> <br> <br>
			<div align="center">
