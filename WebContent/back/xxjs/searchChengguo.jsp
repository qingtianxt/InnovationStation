	...
	<div>
		<div class="nav">
			...
			<ul class="nav-ul">
				...
				<li class="nav-li"><a href="javascript:void(0)">找成果</a></li>
			</ul>
		</div>
		<div>
			<form
				action="${pageContext.request.contextPath }/back/xxjs/xxjsServlet?method=searchChengguo&currentPage=1"
				...
				<table class="result-table">
					...
					<c:forEach varStatus="status" items="${kjcgPagingBean.list }"
						...
						<tr>
							...
							<td>${item.time }</td>
							<td><a
								href="${pageContext.request.contextPath }/back/xxjs/xxjsServlet?method=getChengguoById&id=${item.id}">查看</a>
							</td>
						</tr>
					</c:forEach>
					<tr>
