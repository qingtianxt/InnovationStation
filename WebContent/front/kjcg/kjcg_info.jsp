	...
	<div class="all">
		...
		<div class="content">
			<div class="left" style="background-color:">
				<jsp:include page="kjcg_left.jsp"></jsp:include>
			</div>
			<div class="right" style="background-color:">
				<c:if test="${page==1 }">
					<jsp:include page="kjcg_right_info1.jsp"></jsp:include>
				</c:if>
				<c:if test="${page==2 }">
					<jsp:include page="kjcg_right_info2.jsp"></jsp:include>
				</c:if>
			</div>
		</div>
		<jsp:include
