...
<body>
	<div id="refresh">
		...
		<div class="search">
			<form
				action="${pageContext.request.contextPath }/front/kjcg/kjcgFrontServlet?method=getListByUser&currentPage=1"
		...
		<div class="display">
			...
			<table id="datatable" border="0" cellspacing="0" cellpadding="0">
				<c:forEach items="${kjcgPagingBean.list }" var="p">
					<tr height="40">
						<td width="450" style="text-align: left; font-family: '黑体'">&nbsp;&nbsp;<a
							href="${pageContext.request.contextPath }/front/kjcg/kjcgFrontServlet?method=getById&id=${p.id}"
							target="_blank">${p.mc }</a></td>
						<td width="150" style="text-align: center"><a>${p.km }</a></td>
						<td width="150" style="text-align: center"><a>${p.time }</a></td>
						<td width="100" style="text-align: center"><a>${p.hits }</a></td>
					</tr>
				</c:forEach>
			</table>
			<util:page pagingBean="${kjcgPagingBean }" />
		</div>
