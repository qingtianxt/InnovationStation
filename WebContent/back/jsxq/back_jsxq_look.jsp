...
<div class="nav">
			...
			<ul class="nav-ul">
				...
				<c:if test="${msg.equals('审核') }">
					<li class="nav-li"><a href="javascript:void(0)" onclick="back()">审核需求</a></li>
				</c:if>
				<c:if test="${msg.equals('查看') }">
					<li class="nav-li"><a href="javascript:void(0)" onclick="back()">需求管理</a></li>
				</c:if>
				
				<li class="nav-li"><a href="javascript:void(0)">查看需求</a></li>
			</ul>
		</div>
