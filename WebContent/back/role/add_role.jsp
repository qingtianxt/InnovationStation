...
<div class="nav">
	...
	<ul class="nav-ul">
		...
		<li class="nav-li"><a href="#">添加新角色</a></li>
	</ul>
	</div>
	<br>
	<form name="" method="get">
		<div class="table" align="center">
			角色名:&nbsp;<input id="jsm" name="jsm" type="text"> <br>
			<br>
			...
			<br> 
			<div align="center">
				<input type="submit" value="提交" style="hight: 80px; width: 100px">
			</div>
		</div>
	</form>
	<br>
		...
		$("form").validate({
			rules : {
				jsm : {
					required : true,
					remote : {
						url : "${pageContext.request.contextPath}/back/role/roleServlet",
						type:"GET",
						dataType : "json",
						data : { // 传递的数据
							roleName : function(){
			...
			messages : {
				jsm : {
					required : "请输入角色名称",remote:"该角色名称已经存在！"
				}
			},
