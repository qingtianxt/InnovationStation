	...
	<div>
		<div class="nav">
			...
			<ul class="nav-ul">
				...
				<li class="nav-li"><a href="javascript:void(0)">专家管理</a></li>
			</ul>
		</div>
		<div>
			<form
				action="${pageContext.request.contextPath }/back/zjxx/zjxxServlet?method=getList&currentPage=1"
				...
				<table class="result-table">
					...
					<c:forEach varStatus="status" items="${zjxxPagingBean.list }"
						...
						<tr>
							...
							<td><a href='javasript:void(0)'
								onclick="delete1('${item.id}')">删除</a> | <a
								href='${pageContext.request.contextPath }/back/zjxx/zjxxServlet?method=look&id=${item.id}'>查看</a>
								| <a
								href='${pageContext.request.contextPath }/back/zjxx/zjxxServlet?method=editUI&id=${item.id}'>编辑</a></td>
						</tr>
					</c:forEach>
					<tr>
			...
			layer
					.open({
						...
						yes : function(index, layero) {
							location.href = "${pageContext.request.contextPath}/back/zjxx/zjxxServlet?method=delete&id="
									+ obj;
						},
