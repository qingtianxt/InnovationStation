...
public class EncodingFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws IOException, ServletException {
		...
		if(user==null){
			...
			if(requestURI.startsWith(request.getContextPath()+"/back")){
//				response.sendRedirect(request.getContextPath()+"/front/index.jsp");
				PrintWriter out = response.getWriter();
				out.println("<script>alert('您还没有登录，请先登录！'); \nwindow.top.location.href='"+request.getContextPath()+"/front/index.jsp';</script>");
				return;
			}
