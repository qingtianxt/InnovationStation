...
<body>
	<div id="refresh">
		...
		<div class="search">
			<form
				action="${pageContext.request.contextPath }/front/qyxq/qyxqFrontServlet?method=getList&currentPage=1"
		...
		<div class="display">
			...
			<table id="datatable" class="display-table" border="0" cellspacing="0" cellpadding="0">
				<c:forEach items="${qyxqPagingBean.list }" var="p">
					<tr height="40">
						<td width="450" style="text-align: left; font-family: '黑体'">&nbsp;&nbsp;<a
							href="${pageContext.request.contextPath }/front/qyxq/qyxqFrontServlet?method=getById&id=${p.id}" target="_blank">${p.mc }</a></td>
