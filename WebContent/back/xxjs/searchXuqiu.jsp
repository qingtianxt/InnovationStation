	...
	<div>
		<div class="nav">
			...
			<ul class="nav-ul">
				...
				<li class="nav-li"><a href="javascript:void(0)">找需求</a></li>
			</ul>
		</div>
		<div>
			<form action="${pageContext.request.contextPath }/back/xxjs/xxjsServlet?method=searchXuqiu&currentPage=1"
				method="post" id="checkForm">
				<table class="query-table">
					<tr>
						<td>需求名称：</td>
						<td><input name="mc" type="text" id="mc" width=""
							value="${qyxqPagingBean.mc }" /></td>
						<td>需求说明：</td>
			...
			<div>
				<table class="result-table">
					...
					<c:forEach varStatus="status" items="${qyxqPagingBean.list }" var="item">
						<tr>
							...
							<td><a
								href='${pageContext.request.contextPath }/back/xxjs/xxjsServlet?method=getXuqiuById&id=${item.id}'>查看</a></td>
						</tr>
					</c:forEach>
					<tr>
